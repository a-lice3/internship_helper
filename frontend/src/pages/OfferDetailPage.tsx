    ...
    <div className="page">
        ...
        <div style={{ flex: 1 }}>
          {editing ? (
            <div className="form-grid" style={{ marginBottom: 12 }}>
              ...
              <DateTimeInput mode="date" value={editFields.date_applied} onChange={(v) => setEditFields({ ...editFields, date_applied: v })} placeholder="Date applied" />
            ...
            <>
              ...
              <div style={{ fontSize: 13, color: "var(--text-muted)", marginTop: 4, display: "flex", gap: 16 }}>
                ...
                {offer.date_applied && offer.status !== "bookmarked" && <span>Applied: {offer.date_applied}</span>}
                {offer.link && <a href={offer.link} target="_blank" rel="noreferrer">Link</a>}
              </div>
            </>
          )}
        </div>
      ...
      {autoGenerating && (
        <div className="mistral-generating-banner">
          ...
          <span>Generating skill gap analysis &amp; cover letter...</span>
        </div>
      )}
      ...
      {companyInfo && companyInfo.extract && (
        <div className="glass-card" style={{ marginTop: 20 }}>
          <div className="glass-card-header">
            <h3 style={{ margin: 0 }}>About {offer.company}</h3>
          </div>
      ...
      <div className="bento-grid-2" style={{ marginTop: 16 }}>
        ...
        <div className="glass-card">
          <div className="glass-card-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            >
              {aiLoading && activeAI === "skill-gap" ? "Analyzing..." : "Regenerate"}
            </button>
          </div>
          <div className="glass-card-body" style={{ maxHeight: 300, overflowY: "auto" }}>
            {displaySkillGap ? (
              ...
              <p className="empty" style={{ margin: 0, fontSize: 13 }}>Not yet generated</p>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="glass-card-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button
              ...
              style={{ fontSize: 12, padding: "2px 8px" }}
            >
              {aiLoading && activeAI === "cover-letter" ? "Generating..." : "Regenerate"}
            </button>
          </div>
        </div>
        <div className="glass-card-body">
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 12, marginTop: 10, alignItems: "center", flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, display: "flex", gap: 8, alignItems: "center", minWidth: 280 }}>
                  ...
                  <input
                    placeholder="Ask Mistral to modify your letter..."
                    value={clChatInput}
              ...
              {clChatLoading && (
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 6 }}>
                  ...
                  <span style={{ fontSize: 12, color: "var(--text-muted)" }}>Modifying your letter...</span>
                </div>
              )}
            </div>
          ) : autoGenerating ? (
                  ...
                  {reminders.map((r) =>
                    editingReminderId === r.id ? (
                      <li key={r.id} style={{ flexDirection: "column", gap: 8, padding: "8px 0", alignItems: "stretch" }}>
                        <input placeholder="Title" value={editReminderTitle} onChange={(e) => setEditReminderTitle(e.target.value)} style={{ fontSize: 13 }} />
                        ...
                        <div style={{ display: "flex", gap: 8 }}>
                          ...
                          <button className="btn-cancel" onClick={() => setEditingReminderId(null)} style={{ fontSize: 12 }}>Cancel</button>
                        </div>
                      </li>
                    ) : (
                      <li key={r.id} style={{ padding: "6px 0" }}>
                        ...
                        <button onClick={() => handleDeleteReminder(r.id)} className="btn-icon" title="Delete" style={{ fontSize: 11, padding: "2px 6px" }}>x</button>
                      </li>
                    )
                  )}
                </ul>
          ...
          {showAddReminder && (
            <div style={{
              ...
              <div className="glass-card" style={{ width: 400, maxWidth: "90vw", overflow: "visible" }}>
                <div className="glass-card-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <h3 style={{ margin: 0 }}>New reminder</h3>
                ...
                <div className="glass-card-body" style={{ overflow: "visible" }}>
                  <form onSubmit={handleAddReminder} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 4 }}>
                      <button type="button" className="btn-cancel" onClick={() => setShowAddReminder(false)}>Cancel</button>
                      <button type="submit" className="btn-primary" style={{ boxShadow: "none" }}>Add reminder</button>
                    </div>
                  </form>
                </div>
              </div>
