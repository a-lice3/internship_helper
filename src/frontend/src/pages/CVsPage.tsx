    ...
    return (
      <div className="cv-editor-page">
        <div className="cv-editor-header">
          <button onClick={closeEditor} className="btn-cancel">&larr; Back</button>
            ...
            <div className="cv-chat-messages cv-chat-messages-vertical">
              ...
              {chatMessages.map((msg, i) => (
                <div key={i} className={`cv-chat-msg cv-chat-msg-${msg.role}`}>
                  <span className="cv-chat-msg-role">{msg.role === "user" ? "You" : "AI"}</span>
                  <span className="cv-chat-msg-text">{msg.content}</span>
                </div>
              ))}
              {chatLoading && (
                <div className="cv-chat-msg cv-chat-msg-assistant">
                  <span className="cv-chat-msg-role">AI</span>
                  <span className="cv-chat-msg-text cv-chat-typing">Editing...</span>
                </div>
              )}
              <div ref={chatEndRef} />
            </div>
