...
def test_upload_pdf_template(client, sample_user, tmp_path):
    uid = sample_user["id"]
...
def test_upload_pdf_with_custom_name(client, sample_user, tmp_path):
    uid = sample_user["id"]
...
def test_upload_rejects_non_pdf(client, sample_user):
    uid = sample_user["id"]
    response = client.post(
        f"/users/{uid}/templates/upload",
...
def test_upload_rejects_empty_pdf(client, sample_user, tmp_path):
    uid = sample_user["id"]
...
def test_delete_template_with_file(client, sample_user, tmp_path):
