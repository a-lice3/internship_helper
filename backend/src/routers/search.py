...
from src.llm_service import extract_search_params, match_offers_to_profile
...
def chat_search(
    ...
    try:
        params = extract_search_params(body.message)
    ...
    result = _do_search(user_id, search_body, current_user, db)
...
def search_offers(
    ...
    _verify_owner(user_id, current_user)
    return _do_search(user_id, body, current_user, db)
